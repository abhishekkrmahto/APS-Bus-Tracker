...
const Login = () => {
  ...
  return (
    <div>
      {showAlert && (
        <div
          className="p-4 mb-4 text-sm text-fg-warning rounded-base bg-warning-soft bg-yellow-200"
          role="alert"
        >
          <span className="font-medium bg-yellow-200">Warning alert!</span> Change a few
